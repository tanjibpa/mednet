...
urlpatterns = [
    ...
    path('create', SupplierRawMaterialCreateView.as_view(), name='raw_material_create_view'),
    path('detail/<int:pk>', SupplierRawMaterialDetailView.as_view(), name='raw_material_detail_view'),
    path('edit/<int:pk>', SupplierRawMaterialUpdateView.as_view(), name='raw_material_update_view'),
]
