...
class SupplierRawMaterialCreateView(LoginRequiredMixin, PermissionRequiredMixin, CreateView):
    model = RawMaterial
...
class SupplierRawMaterialUpdateView(LoginRequiredMixin, PermissionRequiredMixin, UpdateView):
    model = RawMaterial
    form_class = RawMaterialForm
    ...
    def get_success_url(self):
        ...
        return reverse_lazy('supplier_inventory:raw_material_detail_view', kwargs={'pk': raw_material.id})


class SupplierRawMaterialDetailView(LoginRequiredMixin, PermissionRequiredMixin, DetailView):
    model = RawMaterial
...
class SupplierRawMaterialListView(LoginRequiredMixin, PermissionRequiredMixin, ListView):
    model = RawMaterial
