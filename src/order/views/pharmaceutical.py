...
class PharmaceuticalRawMaterialOrderCreateView(LoginRequiredMixin, PermissionRequiredMixin, CreateView):
...
class PharmaceuticalRawMaterialOrderListView(LoginRequiredMixin, PermissionRequiredMixin, ListView):
